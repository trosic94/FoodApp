...
export default function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
        await AuthService.resetPassword(data.get('email'));
      ...
      <Container component="main" maxWidth="sm">
        ...
        <Snackbar anchorOrigin={{vertical: "bottom",horizontal: "right"}} open={open} autoHideDuration={6000} onClose={handleClose}>
            ...
            >
                ...
                {"Password reset link sent. Expires in 30minutes!"}
                </DialogTitle>
                <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    We sent password reset email to your inbox. Please check it and click on the activation button.
                </DialogContentText>
                </DialogContent>
                <DialogActions>
